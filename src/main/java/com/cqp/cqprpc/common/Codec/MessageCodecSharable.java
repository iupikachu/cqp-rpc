 ...
 * @author cqp
 * @version 1.0.0
 * @ClassName MessageCodecSharable.java
 * @Description 可共享自定义协议编解码器 必须和 LengthFieldBasedFrameDecoder 一起使用，确保接到的 ByteBuf 消息是完整的
 * @createTime 2021年11月12日 10:29:00
 */
@Slf4j
...
public class MessageCodecSharable extends MessageToMessageCodec<ByteBuf,Message> {
    ...
    protected void encode(ChannelHandlerContext ctx, Message msg, List<Object> out) throws Exception {
        ...
        out.add(byteBuf);  // 添加到list，供后续的 handler 处理
    }
